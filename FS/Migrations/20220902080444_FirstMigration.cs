...
namespace FS.Migrations
{
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CompilationMovie",
                columns: table => new
                {
                    CompilationsId = table.Column<int>(type: "int", nullable: false),
                    MoviesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompilationMovie", x => new { x.CompilationsId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_CompilationMovie_Compilations_CompilationsId",
                        column: x => x.CompilationsId,
                        principalTable: "Compilations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompilationMovie_Movies_MoviesId",
                        column: x => x.MoviesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ratings", x => new { x.UserName, x.MovieId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviePeople", x => new { x.HumanId, x.MovieId, x.RoleId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviePeople_People_HumanId",
                        column: x => x.HumanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompilationMovie_MoviesId",
                table: "CompilationMovie",
                column: "MoviesId");
